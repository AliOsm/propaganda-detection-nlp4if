...
if __name__ == '__main__':
    ...
    parser.add_argument('--predictions-files', nargs='+', default=['submit-rnn-binary-probability.txt', 'submit-universal-sentence-encoder-probability.txt'])
    ...
    with open(join(args.data_dir, 'submit-avg-ensembling.txt'), 'w') as file:
        writer = csv.writer(file, delimiter='\t')

        for prediction in predictions:
            if predictions[prediction] < 0.20:
